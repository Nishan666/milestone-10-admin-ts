...
const FilterDropdown = ({ handlePriceFilter, handleCategoryChange, category, priceRange }) => {
        ...
        <div className="relative inline-block text-left">
            <div className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-medium text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                ...
                >
                    ...
                    <div className="absolute inline-flex items-center justify-center w-4 h-4 text-xs font-semibold text-white bg-blue-500 border-1 border-white rounded-full -top-1 -end-1 dark:border-gray-900">{filterCount}</div>
