    ...
    <div className="flex justify-between items-center shadow-sm pt-2 pb-1 top-0 sticky bg-white  px-10 z-10">
      ...
      <div className="flex items-center">
        ...
        <button
          onClick={openModal}
          type="button"
          className="ms-3 my-0 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
