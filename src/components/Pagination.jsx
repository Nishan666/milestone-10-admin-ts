  ...
  return (
    <div className="sticky bottom-0 bg-white shadow-xl shadow-black py-2">
      <ReactPaginate
        ...
        previousClassName="pagination-default text-gray-700 rounded  hover:bg-blue-400"
        nextClassName="pagination-default text-gray-700 rounded hover:bg-blue-400"
        ...
        pageLinkClassName="block w-full h-full px-4 py-2"
        previousLinkClassName="block w-full h-full px-4 py-2 "
        nextLinkClassName="block w-full h-full px-4 py-2"
        breakLinkClassName="block w-full h-full px-4 py-2"
      />
    </div>
  );
};
